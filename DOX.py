...
A = 1.493*10**-5 # ml-1 inverse volume of patient
...
Doses = [0.5, 1, 2]
#find_peak_intracellular_concentration(Doses, infusion_times,Ke = 0.219*10**(-3), Ki=1.37, Vmax = 0.28, t_half=60*45, P = 100*60*10**(-4), sim_length=30*60, title = 'Minimum Dose to Kill Cancer Cells New Treatment')
Doses = [9, 10, 11]
